...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { age: @preference.age, gender: @preference.gender, interest: @preference.interest, marital_status: @preference.marital_status, name: @preference.name } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { age: @preference.age, gender: @preference.gender, interest: @preference.interest, marital_status: @preference.marital_status, name: @preference.name } }
